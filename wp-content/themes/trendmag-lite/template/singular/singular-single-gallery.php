<?php
$sb_after   = apply_filters('trendmag_lite_get_sidebar', '', 'pos_after');
$sb_before_footer   = apply_filters('trendmag_lite_get_sidebar', 'sb_before_footer', 'pos_single_gallery_before_footer');
