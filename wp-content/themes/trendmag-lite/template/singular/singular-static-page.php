<div class="wrap-top-page has-parallax" data-stellar-background-ratio="0.5">
    <div class="wrapper">
        ...
        <?php
        $enable_breadcrumb = esc_attr( get_theme_mod('header-enable-breadcrumb', '1') );
    ...
    if ( have_posts() ) {
        while ( have_posts() ) {
            ...
            wp_link_pages(array(
                ...
                'after'            => '</p>',
                'next_or_number'   => 'next',
                'nextpagelink'     => '<span class="pull-left">' . __('Next', 'trendmag-lite') . '</span>',
                'previouspagelink' => '<span class="pull-right">' . __('Previous', 'trendmag-lite') . '</span>',
                'echo'             => 1
            ));
